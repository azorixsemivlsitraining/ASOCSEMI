...
export default function DatabaseTest() {
  ...
  const initialTests: TestResult[] = [
    ...
    { name: "Job Applications Table", status: 'pending', message: "Checking table exists..." },
    { name: "Contacts Table", status: 'pending', message: "Checking table exists..." },
    { name: "Get Started Requests Table", status: 'pending', message: "Checking table exists..." },
    { name: "Resume Uploads Table", status: 'pending', message: "Checking table exists..." },
    { name: "Storage Bucket", status: 'pending', message: "Checking file storage..." },
  ];
      ...
      <div className="pt-20 pb-16 px-4">
        <div className="container mx-auto max-w-4xl">
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-green-600">{successes.length} tests passed</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-yellow-600">{warnings.length} optional features</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-red-50 border border-red-200 rounded-xl p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-red-600">{criticalErrors.length} critical issues</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {criticalErrors.length > 0 && (
            <div className="bg-red-50 border border-red-200 rounded-xl p-6">
              <h3 className="text-lg font-semibold text-red-800 mb-4">Setup Required</h3>
              <div className="prose prose-sm max-w-none">
                <ol className="text-red-700">
                  ...
                  <li>Create a new query and paste the contents of <code>database-migration.sql</code></li>
                  <li>Run the migration script to create all necessary tables</li>
