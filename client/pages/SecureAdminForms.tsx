                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-foreground">{(selectedItem as any).file_name}</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-foreground/70">Applicant Name</label>
                      <p className="text-foreground">{(selectedItem as any).applicant_name || "-"}</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-foreground/70">Position</label>
                      <p className="text-foreground">{(selectedItem as any).position || "-"}</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-foreground/70">Upload Date</label>
                      <p className="text-foreground">{formatDate((selectedItem as any).uploaded_at)}</p>
                    </div>
                    <div className="md:col-span-2">
                      <label className="text-sm font-medium text-foreground/70">File URL</label>
                      <a
